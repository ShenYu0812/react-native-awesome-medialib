...
import { View, TouchableOpacity, StyleSheet, Image, StatusBar, PermissionsAndroid, Platform, } from 'react-native';
...
export const CameraPage = (props) => {
    ...
    return (React.createElement(View, { style: styles.container },
        ...
        React.createElement(CameraPreviewView, { style: { width: windowWidth, height } }),
        React.createElement(View, { style: styles.bottomContainer },
            React.createElement(TouchableOpacity, { onPress: () => {
                ...
                React.createElement(Image, { source: isSquare() ? CAMERA_RATIO_ONE : CAMERA_RATIO_43, style: { width: 28, height: 28 } })),
            React.createElement(TouchableOpacity, { onPress: async () => {
                    const pathResult = await takePhoto(isSquare());
                    Image.getSize(pathResult.url, (w, h) => {
                ...
                React.createElement(Image, { source: TAKE_PHOTO_ICON, style: { width: 72, height: 72 } })),
            React.createElement(TouchableOpacity, { onPress: () => {
                    switchCamera();
                }, style: styles.buttonIcon },
                React.createElement(Image, { source: SWITCH_CAMERA, style: { width: 28, height: 28 } })))));
};
